...
const Login = () => {
  ...
  const handleAnonymousLogin = async () => {
    try {
      ...
      setError('Failed to login anonymously: ' + error.message);
    } finally {
      setLoading(false);
    }
  };
        ...
        <div className="mt-6">
          ...
          <div className="mt-6 space-y-3">
            <button
              ...
              disabled={loading}
              className="w-full flex items-center justify-center px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition disabled:opacity-50"
            >
            ...
            <button
              ...
              disabled={loading}
              className="w-full px-4 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 transition disabled:opacity-50"
            >
              Continue as Guest
            </button>
          </div>
